        ...
        private void InitializeComponent()
{
    ...
    this.DateToolStripMenuItem.Text = "По фамилии";
    ...
    this.TypeDepositToolStripMenuItem.Text = "По номеру паспорта";
    ...
    this.FoundForHB.Text = "Поиск по дате открытия счета";
    ...
    this.radioFirstLatter.Checked = true;
