...
namespace Lab_02_OOP
{
    ...
    public class Score
    {
        ...
        {
            var cloneScore = (Score)this.MemberwiseClone();
            cloneScore._owner = new Owner
            {
                Patronymic = _owner.Patronymic,
                FirstName = _owner.FirstName,
                LastName = _owner.LastName,
                NumberPassport = _owner.NumberPassport,
                SeriesPassport = _owner.SeriesPassport
            };
            return cloneScore;
        }
    }
